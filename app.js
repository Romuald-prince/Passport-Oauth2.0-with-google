...
mongoose.connect("mongodb+srv://adminP:test123@cluster0.trqxw.mongodb.net/userDB", {useNewUrlParser: true, useUnifiedTopology: true});
...
passport.use(new FacebookStrategy({
    clientID: process.env.CLIENT_IDS,
    clientSecret: process.env.CLIENT_SECRETS,
    callbackURL: "http://localhost3000/auth/facebook/secrets"
  },
